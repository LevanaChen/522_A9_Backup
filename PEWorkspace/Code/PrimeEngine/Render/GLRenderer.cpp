...
namespace PE {
...
#if APIABSTRACTION_IOS
    IOSMainRenderView *GLRenderer::s_pIOSMainRenderView_objs = NULL;
#endif
    ...
    void GLRenderer::setRenderTargetsAndViewportWithDepth(TextureGPU *pDestColorTex, TextureGPU *pDestDepthTex, bool clearRenderTarget, bool clearDepth)
    {
		...
		else
		{
            ...
            #if APIABSTRACTION_IOS
                [s_pIOSMainRenderView_objs setFramebuffer];
            #else
    ...
    void GLRenderer::initialiseContext()
    {
        ...
        printf("self.view: %d\n", (int)(s_pIOSMainRenderView_objs));
        
        [s_pIOSMainRenderView_objs setContext:context];
        
        //creates frame buffer and sets it to be current framebuffer of the device
        [s_pIOSMainRenderView_objs setFramebuffer];
        
        m_width = s_pIOSMainRenderView_objs->framebufferWidth;
        m_height = s_pIOSMainRenderView_objs->framebufferHeight;
#endif
...
// 			WGL_PIXEL_TYPE_ARB, WGL_TYPE_RGBA_ARB,
    ...
    void GLRenderer::swap(bool vsync /* = 0*/) {
            ...
            if (s_pIOSMainRenderView_objs)
                [s_pIOSMainRenderView_objs presentFramebuffer];
        #else
            SwapBuffers(m_hdc);
        #endif
    }
