...
#include "PrimeEngine/Scene/MapMesh.h"
#include "PrimeEngine/Scene/MapSceneNode.h"
		...
		// start root.PE
		{
			...
			// start root.PE.Components
			{
				PE::Components::Component::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::SceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						...
						PE::Components::MapSceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						PE::Components::InstancingSceneNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					
					// For Assignment 8 : Registry Physics Node
					PE::Components::PhysicsNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
						PE::Components::RootPhysicsNode::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Components::MapMesh::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
			...
			// start root.PE.Events
			{
				PE::Events::Event::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_JOIN_GAME::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);

					// Standard keyboard events
					PE::Events::Event_KEY_P_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_P_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_P_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_A_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_A_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_A_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_S_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_D_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_D_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_D_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					...
					PE::Events::Event_KEY_K_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_K_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_K_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_L_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_L_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_L_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_LEFT_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_LEFT_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_LEFT_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_DOWN_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_RIGHT_DOWN::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_RIGHT_HELD::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
					PE::Events::Event_KEY_RIGHT_UP::InitializeAndRegister(pLuaEnv, pRegistry, setLuaMetaDataOnly);
