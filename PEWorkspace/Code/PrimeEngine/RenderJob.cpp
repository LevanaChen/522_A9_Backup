...
void runDrawThreadSingleFrame(PE::GameContext &ctx)
{
    ...
    // hook in objc game version drawing
    #if APIABSTRACTION_IOS
        //if (ClientGlobalGameCallbacks::getGameInstance()->m_pIOSGameRenderViewController)
        //    [ClientGlobalGameCallbacks::getGameInstance()->m_pIOSGameRenderViewController drawFrame];
    #endif
