...
namespace Components {
    ...
    struct TankController : public PE::Components::Component
    {
		...
		PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_Stop_Timer);
		virtual void do_Stop_Timer(PE::Events::Event *pEvt);

		PE_DECLARE_IMPLEMENT_EVENT_HANDLER_WRAPPER(do_Reload_Car);
		virtual void do_Reload_Car(PE::Events::Event *pEvt);
